...
class SwitchToTypeAdvantage extends Rule{
  ...
  execute(gameState, options, mySide, forceSwitch){
    ...
    for(var i = 0; i < mySide.pokemon.length; i++){
      ...
      if(advantage >= 1 && advantage * poke.hp > mostEffective){
        mostEffective = advantage * poke.hp;
